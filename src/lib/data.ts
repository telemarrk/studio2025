...
export const SERVICES: Service[] = [
  ...
  { id: 'SGDCVTP', name: 'SG - DCVTP', designation: 'DCVTP', password: '1234' },
  ...
  { id: 'SGCS', name: 'SG - CS', designation: 'CS', password: '1234' },
  ...
  { id: 'SGST', name: 'SG - ST', designation: 'ST', password: '1234' },
  ...
  { id: 'SGFETES', name: 'SG - Fêtes et Cérémonies', designation: 'Fêtes et Cérémonies', password: '1234' },
